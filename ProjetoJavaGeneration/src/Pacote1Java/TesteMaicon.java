...
public class TesteMaicon {
	public static void main(String args[]) {
		
		int cont=1, x,y,z, outroscalmos = 0, masc = 0, fem = 0,outros = 0,mascAgressivo = 0,Mnervosas = 0,Pcalmas = 0,calma = 0,nervosa = 0,agressiva = 0,menos18 = 0,mais40 = 0,N40 = 0,c18 = 0;
